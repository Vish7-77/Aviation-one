...
! function() {
    ...
    function e(e) {
        ...
        if ("dropdown" === i && (document.getElementById("ast-mobile-popup").classList.remove("active", "show"), m("updateHeader")), "off-canvas" === i)
    ...
    function m(e) {
        var t = "";
        if (null == (u = c.querySelector("#ast-mobile-header")) || "dropdown" !== u.dataset.type || "updateHeader" === e) {
    ...
    function n(e) {
        ...
        if (void 0 === e && null !== c)
            if (u = c.querySelector("#ast-mobile-header")) e = u.dataset.type;
            else {
        ...
        if ("off-canvas" === e) {
            ...
            for (s.addEventListener("click", function(e) {
                ...
                }), link = 0, len = o.length; link < len; link++) null !== o[link].getAttribute("href") && "#" !== o[link].getAttribute("href") && (o[link].addEventListener("click", g, !0), o[link].headerType = "off-canvas");
            AstraToggleSetup()
        } else if ("dropdown" === e) {
            ...
            for (link = 0, len = r.length; link < len; link++) null !== r[link].getAttribute("href") && "#" !== r[link].getAttribute("href") && (r[link].addEventListener("click", g, !0), r[link].headerType = "dropdown");
            for (link = 0, len = i.length; link < len; link++) i[link].addEventListener("click", g, !0), i[link].headerType = "dropdown";
    ...
    "" !== (u = null != c ? c.querySelector("#ast-mobile-header") : u) && null !== u && (i = u.dataset.type), document.addEventListener("astMobileHeaderTypeChange", e, !1), popupTriggerClick = function(e) {
        var t = e.currentTarget.trigger_type,
            e = document.getElementById("ast-mobile-popup");
        d.classList.contains("ast-popup-nav-open") || d.classList.add("ast-popup-nav-open"), d.classList.contains("ast-main-header-nav-open") || d.classList.add("ast-main-header-nav-open"), document.documentElement.classList.contains("ast-off-canvas-active") || document.documentElement.classList.add("ast-off-canvas-active"), "desktop" === t && (e.querySelector(".ast-mobile-popup-content").style.display = "none", e.querySelector(".ast-desktop-popup-content").style.display = "block"), "mobile" === t && (e.querySelector(".ast-desktop-popup-content").style.display = "none", e.querySelector(".ast-mobile-popup-content").style.display = "block"), this.style.display = "none", e.classList.add("active", "show")
    }, window.addEventListener("load", function() {
        n()
    }), document.addEventListener("astLayoutWidthChanged", function() {
        n()
    }), document.addEventListener("astPartialContentRendered", function() {
        l = document.querySelectorAll(".main-header-menu-toggle"), d.classList.remove("ast-main-header-nav-open"), document.addEventListener("astMobileHeaderTypeChange", e, !1), n(), p()
    });
    var s = window.innerWidth;
    window.addEventListener("resize", function() {
        var e, t, a, n;
        "INPUT" !== document.activeElement.tagName && (e = document.getElementById("menu-toggle-close"), t = document.querySelector(".menu-toggle.toggled"), a = document.querySelector("#masthead > #ast-desktop-header .ast-desktop-header-content"), n = document.querySelector(".elementor-editor-active"), a && (a.style.display = "none"), window.innerWidth !== s && (t && null === n && t.click(), document.body.classList.remove("ast-main-header-nav-open", "ast-popup-nav-open"), e && null == n && e.click()), o(), "dropdown" === i && AstraToggleSetup())
            ...
            if (e) {
                ...
                if (void 0 !== t || void 0 !== (t = e.getElementsByTagName("a")[0])) {
                    ...
                    if (void 0 !== a) {
                        ...
                        for (o = 0, l = n.length; o < l; o++) n[o].addEventListener("focus", b, !0), n[o].addEventListener("blur", b, !0), n[o].addEventListener("click", y, !0)
    ...
    o(), AstraToggleSubMenu = function(e) {
        e.preventDefault();
        var t = this.parentNode;
        t.classList.contains("ast-submenu-expanded") && document.querySelector("header.site-header").classList.contains("ast-builder-menu-toggle-link") && (this.classList.contains("ast-menu-toggle") || "" !== (e = t.querySelector("a").getAttribute("href")) && "#" !== e && (window.location = e));
        for (var a = t.querySelectorAll(".menu-item-has-children"), n = 0; n < a.length; n++) {
        ...
        var e, t;
        if ("undefined" != typeof astraAddon) astraToggleSetupPro(i, d, r);
        else if (0 < (t = (e = "off-canvas" === i || "full-width" === i ? document.querySelectorAll("#ast-mobile-popup, #ast-mobile-header") : document.querySelectorAll("#ast-mobile-header"), document.querySelectorAll("#ast-mobile-header .main-header-menu-toggle"))).length)
            for (var a = 0; a < t.length; a++)
        ...
        if ("undefined" != typeof astraAddon) astraNavMenuTogglePro(e, d, i, this);
        else {
            e.preventDefault();
            var t = document.querySelectorAll("#masthead > #ast-mobile-header .main-header-bar-navigation");
            l = document.querySelectorAll("#masthead > #ast-mobile-header .main-header-menu-toggle");
            e = "0";
            if (null !== this.closest("#ast-fixed-header") && (t = document.querySelectorAll("#ast-fixed-header > #ast-mobile-header .main-header-bar-navigation"), l = document.querySelectorAll("#ast-fixed-header .main-header-menu-toggle"), e = "0"), void 0 === t[e]) return !1;
            for (var a = t[e].querySelectorAll(".menu-item-has-children"), n = 0; n < a.length; n++) {
                a[n].classList.remove("ast-submenu-expanded");
                for (var s = a[n].querySelectorAll(".sub-menu"), o = 0; o < s.length; o++) s[o].style.display = "none"
            } - 1 !== (this.getAttribute("class") || "").indexOf("main-header-menu-toggle") && (astraToggleClass(t[e], "toggle-on"), astraToggleClass(l[e], "toggled"), t[e].classList.contains("toggle-on") ? (t[e].style.display = "block", d.classList.add("ast-main-header-nav-open")) : (t[e].style.display = "", d.classList.remove("ast-main-header-nav-open")))
        }
    ...
    var t, a, v;
    a = navigator.userAgent, v = a.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i) || [], /trident/i.test(v[1]) ? t = /\brv[ :]+(\d+)/g.exec(a) || [] : "Chrome" === v[1] && null != (t = a.match(/\bOPR|Edge\/(\d+)/)) || (v = v[2] ? [v[1], v[2]] : [navigator.appName, navigator.appVersion, "-?"], null != (t = a.match(/version\/(\d+)/i)) && v.splice(1, 1, t[1]), "Safari" === v[0] && v[1] < 11 && bodyElement.classList.add("ast-safari-browser-less-than-11"));
    for (var h = document.getElementsByClassName("astra-search-icon"), f = 0; f < h.length; f++) h[f].onclick = function(e) {
        var t;
